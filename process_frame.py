...
import cv2
import numpy as np
from utils_draw import find_angle, get_landmark_features, draw_text, draw_dotted_line
...
class ProcessFrame:
    ...
    def process(self, frame: np.array, pose):
        ...
        if keypoints.pose_landmarks:
            ...
            # print("Nose Coordinate:", nose_coord)
            # print("Left Shoulder Coordinate:", left_shldr_coord)
            # print("Left Elbow Coordinate:", left_elbow_coord)
            # print("Left Wrist Coordinate:", left_wrist_coord)
            # print("Left Hip Coordinate:", left_hip_coord)
            # print("Left Knee Coordinate:", left_knee_coord)
            # print("Left Ankle Coordinate:", left_ankle_coord)
            # print("Left Foot Coordinate:", left_foot_coord)
            # print("Right Shoulder Coordinate:", right_shldr_coord)
            # print("Right Elbow Coordinate:", right_elbow_coord)
            # print("Right Wrist Coordinate:", right_wrist_coord)
            # print("Right Hip Coordinate:", right_hip_coord)
            # print("Right Knee Coordinate:", right_knee_coord)
            # print("Right Ankle Coordinate:", right_ankle_coord)
            # print("Right Foot Coordinate:", right_foot_coord)
